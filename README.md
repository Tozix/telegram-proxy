...
- 🖥️ Веб-админка + публичный лендинг с документацией и примерами кода
...
| `GET` | `/api/users` | Список администраторов (limit/offset) |
| `POST` | `/api/users` | Добавить администратора |
| `PATCH` | `/api/users/:id` | Сменить пароль/email администратора |
| `DELETE` | `/api/users/:id` | Удалить администратора (не себя/не последнего) |
